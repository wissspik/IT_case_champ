...
from backend.models.shapes import FitbackChat,DeliveryQuestion
...
async def give_banks():
    return {"banks":["Альфа-банк","МТС банк","Ozon банк","ВТБ","Газпромбанк","Т-банк","Почта Банк","Россельхозбанк","Сбербанк","ЮMoney"],"logos":["https://upload.wikimedia.org/wikipedia/commons/8/87/Alfabank_logo.png","https://upload.wikimedia.org/wikipedia/commons/3/36/MTSBank_Logo_800px.png","https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Ozon_logo_clear.svg/640px-Ozon_logo_clear.svg.png","https://upload.wikimedia.org/wikipedia/commons/9/97/Vtb-logo.png","https://logo.clearbit.com/gazprombank.ru?format=png","https://logo.clearbit.com/t-bank.ru?format=png","https://logo.clearbit.com/pochta.ru?format=png","https://logo.clearbit.com/rshb.ru?format=png","https://logo.clearbit.com/sberbank.ru?format=png","https://logo.clearbit.com/yoomoney.ru?format=png"]}
