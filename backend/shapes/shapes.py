...
class BankCommissions(BaseModel):
    currency : Literal["UZS", "KGS", "BYN","TJS", "RUB", "AMD", "KZT", "AZN", "CNY", "VND", "IRR", "RSD", "AED", "ILS", "GEL", "KGS", "EUR", "KRW", "TRY", "MNT", "MDL", "THB", "IDR", "INR", "PHP","USD"]
    ...
    method: Literal['cash','bank_card','FN','mobile','account_number','IBAN','KoronaPay']
